...
resume: |
    ...
    # il y a un "1" après échantillon dans le paragraphe précédent : appel de note de bas de page mais pas de note
    ...
    # il y a un "2" après ilôt dans le paragraphe précédent : appel de note de bas de page mais pas de note
