...
1. Les informations fines de localisation sont perdues et le *positional encoding* n'est pas assez précis pour de la segmentation
...
C'est ces limites que le modèle Segformer développé par Nvidia @segformer tentent de palier. 
