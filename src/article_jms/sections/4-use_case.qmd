...
Pour définir un indicateur qui priorise les îlots à examiner, le rapport entre l’évolution du bâti et celle des logements en dur d’une part et l’ensemble des logements d’autre part ont été calculés.
...
Table : (#tbl-ordre_p) Ordres de priorité des îlots avec sous-couverture de logements supposée
...
Dans cet îlot de la commune de Bandrele (voir @fig-exemple), les contours bleus représentent la prédiction des bâtis en 2021, les points verts ceux cartographiés initialement en 2021 et les points rouges représentent les logements ciblés dans une enquête cartographique complémentaire ultérieure. 

![Exemple d'un examen en 2024 d'un îlot de 2021](/src/article_jms/figure/exemple.png)]{#fig-exemple width=75%}

D’une part, on observe l’apparition de nouveaux logements en 2024, qui ne semblaient pas exister pas au moment de l’enquête cartographique initiale. Ces ajouts sont particulièrement visibles sur la partie supérieure droite de l’image dans la zone circulaire verte : les points rouges apparaissent sans contours bleus.
...
![Présence d'une zone industrielle dans 2 îlots de Kaweni](/src/article_jms/figure/zone_industrielle.png)]{#fig-zone-indu width=75%}
