...
![Exemple d'un examen en 2024 d'un îlot de 2021](../img/etape6.png)]{#fig-exemple width=75%}
...
![Présence d'une zone industrielle dans 2 îlots de Kaweni](../img/etape6.png)]{#fig-zone-indu width=75%}
