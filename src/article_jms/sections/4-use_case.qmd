...
L’enquête cartographique, qui permet de définir la base de sondage, joue un rôle essentiel dans la qualité des estimations du recensement. Si l’enquête cartographique omet des zones à enquêter une année donnée, les populations et nombre de logements déduits de l’EAR - et du recensement de la population (RP) auquel elle contribue - seront sous-estimés. Cela concerne aussi bien les logements en dur, qui sont recensés par sondage mais également les logements de fortune pour lesquels le recensement est exhaustif, même en grande commune. En effet, il peut être difficile pour les agents recenseurs de ratisser l’ensemble du territoire au moment de la collecte pour recenser des logements de fortune qui n’auraient pas été repérés à l’enquête cartographique, notamment dans des zones isolées.


Comme la base de sondage de l’EAR est définie à l’aide de l’enquête cartographique, il a été décidé en 2024 d’effectuer un contrôle de la qualité de cette enquête. Pour ce faire, les données satellites décrites en partie I ont été mobilisées afin de comparer l’évolution de la couverture de bâti obtenue à l’aide du modèle de prédiction avec celle du nombre de logements observé entre la collecte de 2017 et des enquêtes cartographiques des EAR 2021 et 2022. Cette comparaison a été réalisée en agrégeant les données de surface au sein de chaque îlot, pour une année d’enquête donnée.
...
1\. La prédiction de surface de bâti en 2017, 2021 et 2022 issue du modèle de segmentation sémantique mobilisé en partie I est utilisée. Elle permet de mesurer l’évolution du bâti issue des données satellites entre 2017 et 2021 puis entre 2017 et 2022.
...
Dans un premier groupe d’îlots, les deux évolutions sont concordantes (rapport proche de 1). Dans un deuxième groupe d’îlots, plus petit, l’évolution issue des enquêtes cartographiques est plus importante que celle issue des données satellites (rapport inférieur à 1). Le nombre de logements pris en compte pour le processus du RP évolue de manière plus importante que celui de la couverture du bâti. Pour ces deux groupes, la qualité de l’enquête cartographique n’est pas remise en quetion. Dans un troisième et dernier groupe d’îlots, l’évolution du bâti issu des données satellites est plus importante que l’évolution issue des enquêtes cartographiques (rapport supérieur à 1). L’objectif étant d’évaluer une potentielle sous-couverture du bâti lors de l’enquête cartographique, on s’intéresse uniquement aux îlots du troisième groupe.
...
Dans cet îlot de la commune de Bandrele (voir @fig-exemple), les contours bleus représentent la prédiction des bâtis en 2021, les points verts ceux cartographiés initialement en 2021 et les points rouges représentent les logements repérés dans une enquête cartographique complémentaire réalisée en 2024 sur un des îlots ciblés en utilisant les priorités définis précédemment.
