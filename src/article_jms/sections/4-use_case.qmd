...
![Exemple d'un examen en 2024 d'un îlot de 2021](../img/conv.png)]{#fig-exemple width=75%}
...
![Présence d'une zone industrielle dans 2 îlots de Kaweni](../img/conv.png)]{#fig-zone-indu width=75%}
