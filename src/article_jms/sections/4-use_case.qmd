...
Table : ( #tab:ordre_p ) Ordres de priorité des îlots avec sous-couverture de logements supposée
...
Dans cet îlot de la commune de Bandrele (figure 1 @fig-exemple), les contours bleus représentent la prédiction des bâtis en 2021, les points verts ceux cartographiés initialement en 2021 et les points rouges représentent les logements ciblés dans une enquête cartographique complémentaire ultérieure. [![Exemple d'un examen en 2024 d'un îlot de 2021](/src/article_jms/figure/exemple.png)]{#fig-exemple}
