...
- Mission principale de l'Insee : [**le recensement de la population**]{.orange}
- Chaque DROM découpé en [**îlots**]{.blue2}
- Nombre de logements par îlots ?
...
-   [**RIL**]{.orange} 
    ...
    -   [**Bases de sondage**]{.orange} des enquêtes de recensement
